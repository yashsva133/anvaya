...
export const TESTS: Record<string, TestDef> = {
  ...
  triglycerides: {
    ...
    why: {
      en: "Your result is above the preferred range but not extremely high. Doctors consider it together with LDL and HDL.",
      hi: "आपका परिणाम पसंदीदा सीमा से ऊपर है, पर बहुत अधिक नहीं। डॉक्टर इसे LDL और HDL के साथ मिलाकर देखते हैं।",
      vs_en: "Your blood fats are a bit high.",
    },
    causes: {
...
export const REPORTS: Report[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      E("ldl", 154, "high"),
      E("hdl", 36, "low"),
      E("glucose", 126, "borderline"),
      E("triglycerides", 205, "borderline"),
