...
const EN: Dict = {
  ...
  "dash.summaryWriting": "Reading your reports and writing your summary…",
  "dash.summaryBy": "Written by MedGemma from your reports",
  "dash.summaryOffline": "Written from your own report data",
  "dash.summaryRefresh": "Write it again",
  "dash.summaryReports": "reports compared",
  "dash.summaryTrend": "Since your earlier reports",
  "dash.summaryFailed": "Could not reach the summary service. Showing your result counts instead.",
  ...
  "insights.writtenOffline": "Explained from reviewed clinical guidance",
  "insights.basis": "Why this connection was found",
  "insights.storyLoading": "Building your timeline…",
  "insights.reportsCompared": "reports compared",
  "ai.load.reading": "Reading your report…",
  "ai.load.comparing": "Comparing it with your earlier reports…",
  "ai.load.sources": "Checking the guideline sources…",
  "ai.load.writing": "Writing it in simple language…",
  "ai.load.connections": "Looking for connections between results…",
  "ai.load.explaining": "Explaining what each connection means…",
...
const HI: Dict = {
  ...
  "status.borderline": "सीमा के करीब",
  ...
  "dash.aiSummary": "AI सारांश",
  "dash.summaryWriting": "आपकी रिपोर्टें पढ़कर सारांश लिखा जा रहा है…",
  "dash.summaryBy": "MedGemma ने आपकी रिपोर्टों से लिखा",
  "dash.summaryOffline": "आपकी अपनी रिपोर्ट के आँकड़ों से लिखा गया",
  "dash.summaryRefresh": "फिर से लिखें",
  "dash.summaryReports": "रिपोर्टों की तुलना",
  "dash.summaryTrend": "पिछली रिपोर्टों के मुकाबले",
  "dash.summaryFailed": "सारांश सेवा तक नहीं पहुँच सके। फ़िलहाल केवल गिनती दिखाई जा रही है।",
  ...
  "insights.writtenOffline": "समीक्षित क्लिनिकल दिशानिर्देशों से समझाया गया",
  "insights.basis": "यह संबंध क्यों मिला",
  "insights.storyLoading": "आपकी समयरेखा बनाई जा रही है…",
  "insights.reportsCompared": "रिपोर्टों की तुलना",
  "ai.load.reading": "आपकी रिपोर्ट पढ़ी जा रही है…",
  "ai.load.comparing": "पिछली रिपोर्टों से तुलना की जा रही है…",
  "ai.load.sources": "दिशानिर्देश स्रोत जाँचे जा रहे हैं…",
  "ai.load.writing": "सरल भाषा में लिखा जा रहा है…",
  "ai.load.connections": "परिणामों के बीच संबंध खोजे जा रहे हैं…",
  "ai.load.explaining": "हर संबंध का अर्थ समझाया जा रहा है…",
...
const BN: Dict = {
  ...
  "status.borderline": "সীমার কাছাকাছি",
  ...
  "insights.writtenOffline": "পর্যালোচিত ক্লিনিক্যাল নির্দেশিকা থেকে ব্যাখ্যা করা",
  "insights.basis": "এই সংযোগ কেন পাওয়া গেল",
  "insights.storyLoading": "আপনার সময়রেখা তৈরি হচ্ছে…",
  "insights.reportsCompared": "রিপোর্ট তুলনা করা হয়েছে",
  "ai.load.reading": "আপনার রিপোর্ট পড়া হচ্ছে…",
  "ai.load.comparing": "আগের রিপোর্টের সঙ্গে তুলনা করা হচ্ছে…",
  "ai.load.sources": "নির্দেশিকার উৎস যাচাই করা হচ্ছে…",
  "ai.load.writing": "সহজ ভাষায় লেখা হচ্ছে…",
  "ai.load.connections": "ফলাফলের মধ্যে সংযোগ খোঁজা হচ্ছে…",
  "ai.load.explaining": "প্রতিটি সংযোগের অর্থ ব্যাখ্যা করা হচ্ছে…",
  "dash.summaryWriting": "আপনার रिपोर्ट पड़े সারসংক্ষেপ লেখা হচ্ছে…",
  "dash.summaryBy": "MedGemma আপনার रिपोर्ट থেকে লিখেছে",
  "dash.summaryOffline": "আপনার নিজের রিপোর্টের তথ্য থেকে লেখা",
  "dash.summaryRefresh": "আবার লিখুন",
  "dash.summaryReports": "রিপোর্ট তুলনা করা হয়েছে",
  "dash.summaryTrend": "আগের রিপোর্টের তুলনায়",
  "dash.summaryFailed": "সারসংক্ষেপ পরিষেবায় পৌঁছানো যায়নি। আপাতত শুধু গণনা দেখানো হচ্ছে।",
  "mode.simple": "সহজ",
  "mode.advanced": "উন্নত",
